    ...
    if data.startswith('stats'):
        ...
        try:
          ...
          #  ffmpeg = "-map 0 -c:v libx264 -profile:v high -level 4.1 -preset slow -crf 18 -x264-params bluray-compat=1 -c:a eac3 -b:a 448k -ar 48000 -af 'aresample=async=1:min_hard_comp=0.100:first_pts=0,volume=1.5' -c:s copy -metadata title='SharkToonsIndia' -metadata:s:v title='SharkToonsIndia' -metadata:s:a title='SharkToonsIndia' -metadata:s:s title='SharkToonsIndia'"
            ffmpeg = "-map 0 -c:v libx264 -profile:v high -level 4.1 -preset slow -crf 18 -x264-params bluray-compat=1 -c:a eac3 -b:a 640k -ar 48000 -af 'adelay=0|0,aresample=async=1:min_hard_comp=0.100:first_pts=0,volume=1.8' -c:s copy -metadata title='SharkToonsIndia' -metadata:s:v title='SharkToonsIndia' -metadata:s:a title='SharkToonsIndia' -metadata:s:s title='SharkToonsIndia'"
